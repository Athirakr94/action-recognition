...
file = open('./../input/data_kinetics.csv')
...
# df = pd.read_csv('../input/data2d.csv')
...
class ImageDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        # image = Image.open(os.getcwd()+"/"+str(image_path))
        ...
        # print(image_tensor,label_tensor)
...
def fit(model, train_dataloader):
    ...
    for i, data in tqdm(enumerate(train_dataloader), total=int(len(train_data)/train_dataloader.batch_size)):
        ...
        optimizer.zero_grad()
        outputs = model(data)
        print(target,type(target),outputs,type(outputs))
